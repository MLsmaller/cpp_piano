...
class BiSeNet(torch.nn.Module):
    def __init__(self, num_classes,backbone='resnet18',freeze_bn=False,):
        super().__init__()
        # build spatial path
    ...
    def get_backbone_params(self):
        return chain(self.saptial_path.parameters(), self.attention_refinement_module1.parameters(), self.attention_refinement_module2.parameters(), 
                   self.supervision1.parameters(), self.supervision2.parameters())

    def get_decoder_params(self):
        return chain(self.feature_fusion_module.parameters(), self.conv.parameters())
